...
class NotificationsListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Consumer<NotificationsProvider>(
        builder: (_, NotificationsProvider notificationsProvider, __) {
      final List<PushNotification> _notifications = notificationsProvider.notifications;
    ...
    /* return FutureBuilder(
      future: Provider.of<PushNotificationsProvider>(context, listen: false).fetchNotifications(),
