...
import 'package:identitic/src/ui/pages/inattendances/widgets/inattendances_list_view.dart';
          ...
          Padding(
            ...
            child: Column(
              children: <Widget>[
                CircleAvatar(
                  ...
                  child: Consumer<InattendancesProvider>(
                    builder: (_, InattendancesProvider inattendancesProvider, __) {
                      return Text(
                        inattendancesProvider.inattendances?.length?.toString() ?? '...',
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 32
                        ),
                ...
                SizedBox(height: 16),
                Text('Inasistencias totales', style: TextStyle(fontSize: 18),),
              ],
            ),
          ),
          Expanded(
